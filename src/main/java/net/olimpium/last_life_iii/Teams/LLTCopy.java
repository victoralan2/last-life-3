...
public class LLTCopy implements Serializable {
    ...
    public LLTCopy(@NotNull String name, @NotNull List<UUID> players) throws MaxTeamMembersExceeded, IllegalArgumentException, NullPointerException {
